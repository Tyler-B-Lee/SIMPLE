...
# start
# docker-compose exec app mpirun -np 2 python3 train.py -e root4pbasealliance -ne 25 -ef 20480 -tpa 2048 -ent 0.025 -ob 128 -g 0.995 -oe 6 -t 0
...
OPPONENT_INFO = [(MARQUISE_ID,"root4pbasemarquise"),(EYRIE_ID,"root4pbaseeyrie"),(VAGABOND_ID,"root4pbasevagabond")]
