...
class MancalaEnv(gym.Env):
    ...
    def __init__(self, verbose = False, manual = False):
        ...
        self.observation_space = gym.spaces.Box(0, 1, (self.num_pits * 22 + self.n_players + self.board_size,))
    ...
    def observation(self):
        ...
        if self.current_player.id == '1':
            ...
            start_i = 7
            opponent_i = 0
        obs = np.zeros([self.num_pits, 22]) # SET MAX NUMBER OF SEEDS IN ONE PIT
